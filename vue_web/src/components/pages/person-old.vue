...
<script>
    export default {
      ...
      mounted() {
        ...
        let self = this;
        //加载文字数据
        $.get("http://101.201.148.141:8083/goods/getMyGoods.do",jsonObj,function (data) {
          self.tableData = data;
          //为每个表格元素加载图片数据，主图
      ...
      methods:{
        ...
        handleEdit(index, row) {
          ...
          let jsonMsg = JSON.stringify(jsonObj);
          let self = this;
          $.get("http://101.201.148.141:8083/goods/getGoodsDscrip.do",jsonObj,function (data) {
            if(data !== "" || data !== null) {
        ...
        handleEdit2(index, row) {
          ...
          let jsonMsg = JSON.stringify(jsonObj);
          let self = this;
          $.post("http://101.201.148.141:8083/goods/deleteMyGoodsAndUrls.do",jsonMsg,function (data) {
            if(data.code === 1){
        ...
        submitDscrip(){
          ...
          let jsonMsg = JSON.stringify(jsonObj);
          let self = this;
          $.post("http://101.201.148.141:8083/goods/saveGoodsDscrip.do",jsonMsg,function (data) {
            if(data.code === 1){
