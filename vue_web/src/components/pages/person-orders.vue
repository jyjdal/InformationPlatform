...
<script>
    export default {
      ...
      mounted() {
        ...
        let self = this;
        //加载文字数据
        $.get("http://101.201.148.141:8083/orders/getOrdersAllByUserId.do",jsonObj,function (data) {
          self.tableData = data;
          //更改前端显示文字
      ...
      methods: {
        ...
        submitFeedback(){
          ...
          $.post("http://101.201.148.141:8083/feedback/submitFeedback.do",jsonMsg,function (data) {
            if(data.code === 1){
